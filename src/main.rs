...
use crate::operations::math::{Factorial, Logarithm, PowInteger, PowReal, PowerOfTwo, Exponential, cos};
fn main() {
    // let fixed = fi::fi{sign: false, value: vec![false, true, false, true, true, true, false, false, true]};
    // let string = "109019".to_string();
    let n1: FiBin = FiBin::from(String::from("2"));
    let n2: FiBin = FiBin::from(String::from("14"));
    let dividend: FiBin = FiBin::from(String::from("15.0"));
    ...
    // println!("round: {:?}", dividend.to_long().to_bin().to_string());
    // println!("{:?}, {:?}", new1, new2);
    ...
    println!("{:?}", FiLong::from("1.0986122886681096913952452369225"));
    println!("{:?}", FiLong::from("1.6094379124341003746007593332262"));
    println!("{:?}", FiLong::from("7.389056098930650227230427460575"));
    println!("{:?}", FiLong::from("9.8696044010893586188344909998762"));
